...
// thuannd start: defines new data type
...
enum LedgerEntryType
{
    ...
    //DATA = 3
    // thuannd end
    // thuannd start: add CONTRACTSTATE
    DATA = 3,
    CONTRACTSTATE = 4
    // thuannd end
};
...
// thuannd start: add new table for smart contract
/* ContractStateEntry

    Using for the contracts
