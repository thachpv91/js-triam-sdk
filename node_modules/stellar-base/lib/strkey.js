...
// thuannd start
   ...
   * @returns {string}
   */
  static encodeContractKey(data) {
    return encodeCheck("preContract", data);
  }
// thuannd end
...
// thuannd start
   ...
   * @returns {Buffer}
   */
  static decodeContractKey(data) {
    return decodeCheck("preContract", data);
  }
// thuannd end
...
// thuannd start
   ...
   * @param {string} contractKey contract key to check
   * @returns {boolean}
   */
  static isValidContractKey(contractKey) {
    return isValid("preContract", contractKey);
  }
// thuannd end
...
export function encodeCheck(versionByteName, data) {
  ...
  if (isUndefined(versionByte)) {
    ...
    throw new Error(`${versionByteName} is not a valid version byte name.  expected one of "ed25519PublicKey", "ed25519SecretSeed", "preAuthTx", "sha256Hash", "preContract"`);
    // thuannd end
  }
