...
//
// ===========================================================================
xdr.typedef("ContractID", xdr.lookup("PublicKey"));
...
//
// ===========================================================================
xdr.typedef("String128", xdr.string(128));
...
//
// ===========================================================================
xdr.typedef("ContractParams", xdr.varOpaque());
...
//
// ===========================================================================
xdr.typedef("ContractExeCode", xdr.varOpaque());
...
//
// ===========================================================================
xdr.typedef("StateString", xdr.varOpaque());
...
//
// ===========================================================================
xdr.struct("ContractInput", [
  ["funcName", xdr.lookup("String64")],
  ["contractParams", xdr.lookup("ContractParams")],
]);
...
//
// ===========================================================================
xdr.struct("ContractOutput", [
  ["newState", xdr.lookup("StateString")],
  ["exeCode", xdr.lookup("ContractExeCode")],
]);
...
//
// ===========================================================================
xdr.union("ContractStateEntryExt", {
  switchOn: xdr.int(),
  switchName: "v",
  switches: [
    [0, xdr.void()],
...
//       int32 lastModified;      // Number of ledger modified state contract
//       int32 nonce;             // Start at 0, increase 1 when state change
//   
//       // reserved for future use
//       union switch (int v)
//       {
...
//
// ===========================================================================
xdr.struct("ContractStateEntry", [
  ["accountId", xdr.lookup("AccountId")],
  ["state", xdr.lookup("String64")],
  ["stateHash", xdr.lookup("String64")],
  ["lastTxModified", xdr.lookup("String64")],
  ["lastModified", xdr.option(xdr.lookup("Int32"))],
  ["nonce", xdr.lookup("Int32")],
  ["ext", xdr.lookup("ContractStateEntryExt")],
]);
...
xdr.union("LedgerEntryData", {
  ...
  arms: {
    ...
    // thuannd start
    data: xdr.lookup("ContractStateEntry"),
    // thuannd end
  },
});
...
//
// ===========================================================================
xdr.struct("LedgerKeyContractState", [
  ["accountId", xdr.lookup("AccountId")],
]);
...
xdr.union("LedgerKey", {
  ...
  arms: {
    ...
    // thuannd start
    contractState: xdr.lookup("LedgerKeyContractState"),
    // thuannd end
  },
});
...
//       MANAGE_DATA = 10,
// thuannd start
//       BUMP_SEQUENCE = 11, //BUMP_SEQUENCE = 11
//       CREATE_CONTRACT = 12,
//       CALL_CONTRACT = 13,
//       SEND_ASSET = 14,
//       CHECK_CONTRACT = 15,
...
//   {
//       ContractID contractId;  // auto gen by core based on a file that is gotten from url
//       int64 startingBalance;  // amount they end up with
//       string128 contractAddr; // address of contract
//       ContractInput data;     // data for contract
//       string256 state;        // state that is returned from smart contract host
//   };
//
// ===========================================================================
xdr.struct("CreateContractOp", [
  ["contractId", xdr.lookup("ContractID")],
  ["startingBalance", xdr.lookup("Int64")],
  ["contractAddr", xdr.lookup("String128")],
  ["data", xdr.lookup("ContractInput")],
  ["state", xdr.lookup("String256")],
]);
...
//   struct SendAssetOp
//   {
//       ContractID contractId; // a public key of the contract
//       Asset asset;           // what they end up with
//       int64 amount;          // amount they end up with
//       string256 state;        // state that is returned from smart contract host
//   };
...
// === xdr source ============================================================
//
//   struct CheckContractOp
//   {
//       int32 isContract; // check isContract
//   };
//
// ===========================================================================
xdr.struct("CheckContractOp", [
  ["isContract", xdr.lookup("Int32")],
]);
...
// ===========================================================================
xdr.struct("Check", [
  ["sourceAccId", xdr.lookup("AccountId")],
  ["amount", xdr.lookup("Int64")],
  ["op", xdr.lookup("String32")],
]);
...
// === xdr source ============================================================
//
//   union switch (ContrOperationType type)
//       {
//       case CHECK:
//           Check check;
//       case INVOKE:
...
//
// ===========================================================================
xdr.union("ContrOperationBody", {
  switchOn: xdr.lookup("ContrOperationType"),
  switchName: "type",
  switches: [
    ["check", "check"],
    ["invoke", "invoke"],
  ...
  arms: {
    check: xdr.lookup("Check"),
    invoke: xdr.lookup("Invoke"),
    query: xdr.lookup("Query"),
    transfer: xdr.lookup("Transfer"),
  },
});

// === xdr source ============================================================
//
//   struct ContrOperation
//   {
//   
//   union switch (ContrOperationType type)
//       {
...
//
// ===========================================================================
xdr.struct("ContrOperation", [
  ["body", xdr.lookup("ContrOperationBody")],
]);


// === xdr source ============================================================
//
//   struct CallContractOp
//   {
//       ContractID contractId; // a public key of the contract
//       ContractInput data;   // data for contract
//       ContrOperation contrOps<100>;
//   };
//
// ===========================================================================
xdr.struct("PaymentOp", [
  ["contractId", xdr.lookup("ContractID")],
  ["data", xdr.lookup("ContractInput")],
  ["contrOps", xdr.varArray(xdr.lookup("ContrOperation"), 100)],
]);
...
//       case CALL_CONTRACT:
//           CallContractOp callContractOp;
//       case SEND_ASSET:
//           SendAssetOp sendAssetOp;
//       case CHECK_CONTRACT:
//           CheckContractOp checkContractOp;
// thuannd end
//       }
//
// ===========================================================================
xdr.union("OperationBody", {
  ...
  switches: [
    ...
    ["callContract", "callContractOp"],
    ["sendAsset", "sendAssetOp"],
    ["checkContract", "checkContractOp"],
    // thuannd end
  ],
  arms: {
    ...
    // thuannd start
    createContractOp: xdr.lookup("CreateContractOp"),
    callContractOp: xdr.lookup("CallContractOp"),
    sendAssetOp: xdr.lookup("SendAssetOp"),
    checkContractOp: xdr.lookup("CheckContractOp"),
    // thuannd end
  },
});
...
//   {
//      // codes considered as "success" for the operation
//      CREATE_CONTRACT_SUCCESS = 0, // contract was created
//      // codes considered as "failure" for the operation
//      CREATE_CONTRACT_MALFORMED = -1,   // invalid destination
//      CREATE_CONTRACT_UNDERFUNDED = -2, // not enough funds in source account
//      // would create an contract below the min reserve
//      CREATE_CONTRACT_LOW_RESERVE = -3,
//      CREATE_CONTRACT_ALREADY_EXIST = -4 // contract already exists
//   };
//
// ===========================================================================
xdr.enum("CreateContractResultCode", {
  createContractSuccess = 0,
  createContractMalformed = -1,
  createContractUnderfunded = -2,
  createContractLowReserve = -3,
  createContractAlreadyExist = -4,
});
...
//
// ===========================================================================
xdr.union("CreateContractResult", {
  switchOn: xdr.lookup("CreateContractResultCode"),
  switchName: "code",
  switches: [
    ["createContractSuccess", xdr.void()],
  ],
  arms: {
  },
  defaultArm: xdr.void(),
...
// === xdr source ============================================================
//
//   enum SendAssetResultCode
//   {
        // // codes considered as "success" for the operation
        // SEND_ASSET_SUCCESS = 0, // sendAsset successfuly completed
        // // codes considered as "failure" for the operation
        // SEND_ASSET_MALFORMED = -1,          // bad input
        // SEND_ASSET_UNDERFUNDED = -2,        // not enough funds in source account
        // SEND_ASSET_SRC_NO_TRUST = -3,       // no trust line on source account
        // SEND_ASSET_SRC_NOT_AUTHORIZED = -4, // source not authorized to transfer
        // SEND_ASSET_NO_DESTINATION = -5,     // contract does not exist
        // SEND_ASSET_NO_TRUST = -6,       // contract missing a trust line for asset
        // SEND_ASSET_NOT_AUTHORIZED = -7, // contract not authorized to hold asset
        // SEND_ASSET_LINE_FULL = -8,      // contract would go above their limit
        // SEND_ASSET_NO_ISSUER = -9,       // missing issuer on asset
        // SEND_ASSET_NO_CONTRACT_STATE = -10 // contractState does not exist
//   };
//
// ===========================================================================
xdr.enum("SendAssetResultCode", {
    sendAssetSuccess = 0,
    sendAssetMalformed = -1,
    sendAssetUnderfunded = -2,
    sendAssetSrcNoTrust = -3,
    sendAssetSrcNotAuthorized = -4,
    sendAssetNoDestination = -5,
    sendAssetNoTrust = -6,
    sendAssetNotAuthorized = -7,
    sendAssetLineFull = -8,
    sendAssetNoIssuer = -9,
    sendAssetNoContractState = -10,
});

// === xdr source ============================================================
//
//   union SendAssetResult switch (SendAssetResultCode code)
//   {
...
//
// ===========================================================================
xdr.union("SendAssetResult", {
  switchOn: xdr.lookup("SendAssetResultCode"),
  switchName: "code",
  switches: [
    ["sendAssetSuccess", xdr.void()],
  ],
  arms: {
  },
  defaultArm: xdr.void(),
...
// === xdr source ============================================================
//
//   enum CallContractResultCode
//   {
        // // codes considered as "success" for the operation
        // CALL_CONTRACT_SUCCESS = 0, // callContract successfuly completed
        // // codes considered as "failure" for the operation
        // CALL_CONTRACT_MALFORMED = -1,          // bad input
        // CALL_CONTRACT_NO_CONTRACT_STATE = -2,  //
        // CALL_CONTRACT_CHECK_AMOUNT = -3,       //
        // CALL_CONTRACT_UNDERFUNDED = -4,        //
        // CALL_CONTRACT_SRC_NO_TRUST = -5,       //
        // CALL_CONTRACT_SRC_NOT_AUTHORIZED = -6, //
        // CALL_CONTRACT_NO_DESTINATION = -7,     //
        // CALL_CONTRACT_NO_TRUST = -8,           //
        // CALL_CONTRACT_NOT_AUTHORIZED = -9,     //
        // CALL_CONTRACT_LINE_FULL = -10,         //
        // CALL_CONTRACT_NO_ISSUER = -11,         //
        // CALL_CONTRACT_OVER_SENDMAX = -12       //
//   };
//
// ===========================================================================
xdr.enum("CallContractResultCode", {
    callContractSuccess = 0,
    callContractMalformed = -1,
    callContractNoContractState = -2,
    callContractCheckAmount = -3,
    callContractUnderfunded = -4,
    callContractSrcNoTrust = -5,
    callContractSrcNotAuthorized = -6,
    callContractNoDestination = -7,
    callContractNoTrust = -8,
    callContractNotAuthorized = -9,
    callContractLineFull = -10,
    callContractNoIssuer = -11,
    callContractOverSendmax = -12,
});

// === xdr source ============================================================
//
//   union CallContractResult switch (CallContractResultCode code)
//   {
//   case CALL_CONTRACT_SUCCESS:
//       void;
//   default:
//       void;
//   };
//
// ===========================================================================
xdr.union("CallContractResult", {
  switchOn: xdr.lookup("CallContractResultCode"),
  switchName: "code",
  switches: [
    ["callContractSuccess", xdr.void()],
  ],
  arms: {
  },
  defaultArm: xdr.void(),
...
// === xdr source ============================================================
//
//   enum CheckContractResultCode
//   {
        // // codes considered as "success" for the operation
        // CHECK_CONTRACT_SUCCESS = 0, // account was created

        // // codes considered as "failure" for the operation
        // CHECK_CONTRACT_MALFORMED = -1,   // invalid destination
//   };
//
// ===========================================================================
xdr.enum("CheckContractResultCode", {
    // codes considered as "success" for the operation
    checkContractSuccess = 0, // account was created
    // codes considered as "failure" for the operation
    checkContractMalformed = -1,   // invalid destination
});

// === xdr source ============================================================
//
//   union CheckContractResult switch (CheckContractResultCode code)
//   {
...
//
// ===========================================================================
xdr.union("CheckContractResult", {
  switchOn: xdr.lookup("CheckContractResultCode"),
  switchName: "code",
  switches: [
    ["checkContractSuccess", xdr.void()],
  ],
  arms: {
  },
  defaultArm: xdr.void(),
...
// thuannd start
      ...
      // case SEND_ASSET:
          // SendAssetResult sendAssetResult;
      // case CHECK_CONTRACT:
          // CheckContractResult checkContractResult;
// thuannd end
//       }
//
// ===========================================================================
xdr.union("OperationResultTr", {
  ...
  switches: [
    ...
    ["callContract", "callContractResult"],
    ["sendAsset", "sendAssetResult"],
    ["checkContract", "checkContractResult"],
    // thuannd end
  ],
  arms: {
    ...
    // thuannd start
    createContractResult: xdr.lookup("CreateContractResult"),
    callContractResult: xdr.lookup("CallContractResult"),
    sendAssetResult: xdr.lookup("SendAssetResult"),
    checkContractResult: xdr.lookup("CheckContractResult"),
    // thuannd end
  },
});
...
// thuannd start
//       KEY_TYPE_HASH_X = 2, //KEY_TYPE_HASH_X = 2
//       KEY_TYPE_PRE_CONTRACT = 3
// thuannd end
//   };
//
// ===========================================================================
...
//   {
// thuannd start
//       PUBLIC_KEY_TYPE_ED25519 = KEY_TYPE_ED25519,// PUBLIC_KEY_TYPE_ED25519 = KEY_TYPE_ED25519
//       PUBLIC_KEY_TYPE_CONTRACT = KEY_TYPE_PRE_CONTRACT
// thuannd end
//   };
//
// ===========================================================================
...
// thuannd start
//       SIGNER_KEY_TYPE_HASH_X = KEY_TYPE_HASH_X, //SIGNER_KEY_TYPE_HASH_X = KEY_TYPE_HASH_X
//       SIGNER_KEY_TYPE_PRE_CONTRACT = KEY_TYPE_PRE_CONTRACT
// thuannd end
//   };
//
// ===========================================================================
...
xdr.union("PublicKey", {
  ...
  switches: [
    ...
    // thuannd start
    ["publicKeyTypeContract", "contract"],
    // thuannd end
  ],
  arms: {
    ed25519: xdr.lookup("Uint256"),
    // thuannd start
    contract: xdr.lookup("Uint256"),
    // thuannd end
  },
});
...
//       uint256 hashX;
// thuannd start
//   case SIGNER_KEY_TYPE_PRE_CONTRACT:
//       uint256 contract;
// thuannd end
//   };
//
...
xdr.union("SignerKey", {
  ...
  switches: [
    ...
    // thuannd start
    ["signerKeyTypePreContract", "contract"],
    // thuannd end
  ],
  arms: {
    ed25519: xdr.lookup("Uint256"),
