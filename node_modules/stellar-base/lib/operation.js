...
export class Operation {
  ...
  static fromXDRObject(operation) {
    ...
    switch (operation.body().switch().name) {
      ...
      result.contractAddr = attrs.contractAddr() ? attrs.contractAddr().toString('ascii') : null;

      // thuannd notes data
      if (attrs.data()) {
        let data = {};
        data.funcName = attrs.funcName().toString();
      ...
      // ContrOperations
      result.contrOps = attrs.contrOps();
      ...
      result.isContract = this._fromXDRIsContract(attrs.isContract());
      break;
      // thuannd end
      default:
